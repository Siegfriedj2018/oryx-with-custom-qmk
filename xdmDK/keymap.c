...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_GRAVE,       KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_LEAD,                                                                          TT(2),          KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_ENTER,       
  ...
  [1] = LAYOUT_moonlander(
    ...
    HSV_74_255_206, KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_LEAD,                                                                 KC_TRANSPARENT, KC_DOWN,        KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    ...
    MU_NEXT,        KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_LEAD,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LCTL(LSFT(KC_ESCAPE)),LCTL(KC_I),     LCTL(KC_R),     LCTL(LSFT(KC_P)),KC_TRANSPARENT, KC_LEAD,                                                                 KC_TRANSPARENT, KC_UNDS,        KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEAD,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_M,                                                                           KC_LEAD, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
void leader_end_user(void) {
  if (leader_sequence_is(KC_1)) {
    layer_on(1)
  } else if (leader_sequence_is(KC_2)) {
    layer_on(2)
  }else if (leader_sequence_is(KC_3)) {
    layer_on(3)
  }else if (leader_sequence_is(KC_4)) {
    layer_on(4)
  }else if (leader_sequence_is(KC_5)) {
    layer_on(5)
  }
}
