...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_GRAVE,       KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_NO,                                        TT(2),          KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_ENTER,       
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RIGHT_SHIFT, 
    KC_LEFT_CTRL,   KC_CAPS,        KC_CYCLE_LAYERS,KC_LEFT,       KC_RIGHT,       KC_LEFT_GUI,                                                                    DUAL_FUNC_0,    KC_UP,          KC_DOWN,        KC_LBRC,        KC_RBRC,        KC_LEFT_CTRL,   
  ...
  [1] = LAYOUT_moonlander(
    ...
    HSV_74_255_206, KC_HASH,        KC_DLR,         KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_NO,                                                                 KC_TRANSPARENT, KC_DOWN,        KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    ...
    MU_NEXT,        KC_TRANSPARENT, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    KC_TRANSPARENT, KC_NO,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_MEDIA_PLAY_PAUSE,
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, LCTL(LSFT(KC_ESCAPE)),LCTL(KC_I),     LCTL(KC_R),     LCTL(LSFT(KC_P)),KC_TRANSPARENT, KC_NO,                                                                 KC_TRANSPARENT, KC_UNDS,        KC_4,           KC_5,           KC_6,           KC_PLUS,        KC_TRANSPARENT, 
  ...
  [5] = LAYOUT_moonlander(
    ...
    KC_NO,          KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_M,                                           KC_NO, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
